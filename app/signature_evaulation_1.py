...
def filter_xaif(xaif_data):
    ...
    if "locutions" in xaif_data["AIF"]:
        for i, locution in enumerate(xaif_data["AIF"]["locutions"]):
            ...
            locution['start'] = timestamp
            locute.append(locution)
    ...
    filtered_xaif["AIF"]["locutions"] = locute
...
def generate_predictions_signature_evaulation_1(input_xaif_data):
